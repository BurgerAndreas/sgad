#!/bin/bash
#SBATCH -A aip-aspuru
#SBATCH -D /project/aip-aspuru/aburger/sgad
#SBATCH --time=71:00:00
#SBATCH --gres=gpu:l40s:1
#SBATCH --mem=64GB
#SBATCH --cpus-per-task=2
#SBATCH --job-name=sgad
# Jobs must write their output to your scratch or project directory (home is read-only on compute nodes).
#SBATCH --output=/project/aip-aspuru/aburger/sgad/outslurm/slurm-%j.txt 
#SBATCH --error=/project/aip-aspuru/aburger/sgad/outslurm/slurm-%j.txt
